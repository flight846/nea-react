            ...
            <div className="paddingBottom50">
              ...
              <div className="tabsContainer">
                <ul className="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" id="certification-tab" data-toggle="tab" href="#certification" role="tab" aria-controls="certification" aria-selected="false">Certification</a>
                  </li>
                </ul>
                <div className="tab-content" id="tab-info">
                  <div className="tab-pane fade mb-5 show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                    <div className="tab-pane__group shadow-sm">
                      <p className="tab-pane__title text-bold" style={{border: '1px solid #f5f5f5;'}}>FORM 3 ID: 014989</p>
                  ...
                  <div className="tab-pane fade mb-5" id="analysis" role="tabpanel" aria-labelledby="analysis-tab">
                  ...
                  <div className="tab-pane fade mb-5" id="certification" role="tabpanel" aria-labelledby="certification-tab">
                    <div className="tab-pane__group shadow-sm">
                      <div className="card bg-white">
                        <div className="card-body">
                          <div className="row">
