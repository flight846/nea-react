import { getAuditTaskList } from 'services/vectorInspection';
...
export const filterAuditTaskAction = ({ searchText, searchType, sortValue, filterValue, datePickerValue }) => (
  dispatch,
  getState,
) => {
  const {
...
export const getAuditTaskListAction = () => async dispatch => {
  ...
  await actionTryCatchCreator(getAuditTaskList(), onPending, onSuccess, onError);
};
